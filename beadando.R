...
# 4. Ábra: 2048x768 felbontású PNG fájl
# Fájl megnyitás:
#png(file = "Eszter_bead.png", width = 2048, height = 768)
#?png

savepar <- par()
par(mfrow=c(1,3))

# Olyan módon, hogy a végső ábrán 6 (al)ábra legyen egyben,egy fő felirattal 
# és 6 alfelirattal
# IDŐSOROKHOZ HASONLÓ: https://observablehq.com/@d3/multi-line-chart 
# (NEM DINAMIKUS, VISZONT SZINES jelmagyarázattal! Mindegy sima plot vagy GGPLOT2)
